...
/* Generated from ../O.Common/HESEB.dbd */
...
int HESEB_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/control/HESEBScanTool/IOCs/HESEB_DAQ";
...
/* HESEB_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"HESEB_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    HESEB_registerRecordDeviceDriver(*iocshPpdbbase);
}
