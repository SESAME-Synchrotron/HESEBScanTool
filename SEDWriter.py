...
Modified data: Jan 10, 2024 (100% Tested version)
...
& Anas Mohammad, anas.mohammad@sesame.org.jo
...
class SEDWriter:
	...
	def pathValCrt(self):
		# Validate / create file location (path)
		...
		if not (_pathExist):
			...
			if (_fileExist):
				...
				print("The path: " + Back.RED + self.fPath, Style.RESET_ALL,
					"belongs to an already existed file "\
	...
	def pathExist(self):
		# check folder or file paths if exist??
...
class CSVWriter(SEDWriter):
	def __init__ (self, fName, fPath, columns, data, fMode = "a", wMode = "D"):
	...
	def DCSVCreate (self):
		# Dictionary based writing i.e. {'SN':1, 'Name':'Mustafa'}
