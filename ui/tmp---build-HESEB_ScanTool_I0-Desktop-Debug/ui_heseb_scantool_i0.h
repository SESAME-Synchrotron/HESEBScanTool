...
"padding: 0 3px 0 3px;"));
        ...
        gridLayout_16->addWidget(qepushbutton_9, 1, 3, 1, 1);
        ...
        gridLayout_16->addWidget(qepushbutton_7, 1, 1, 1, 1);
        ...
        gridLayout_16->addWidget(qepushbutton_8, 1, 2, 1, 1);

        readMorePVs = new QPushButton(centralwidget);
        readMorePVs->setObjectName(QStringLiteral("readMorePVs"));

        gridLayout_16->addWidget(readMorePVs, 1, 4, 1, 1);
...
"}"));
    ...
    void retranslateUi(QMainWindow *HESEB_ScanTool_I0)
    {
        ...
        readMorePVs->setText(QApplication::translate("HESEB_ScanTool_I0", "BL Parameters", Q_NULLPTR));
